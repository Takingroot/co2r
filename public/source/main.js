...
require.define("/vendor/index.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
...
require.define("/vendor/angular/index.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
...
require.define("/vendor/angular/angular.js",function(require,module,exports,__dirname,__filename,process){/**
...
require.define("/vendor/angular/angular_resource.js",function(require,module,exports,__dirname,__filename,process){/**
 * @license AngularJS v1.0.1
 * (c) 2010-2012 Google, Inc. http://angularjs.org
 * License: MIT
 */
...
require.define("/vendor/jquery.min.js",function(require,module,exports,__dirname,__filename,process){/*! jQuery v@1.8.1 jquery.com | jquery.org/license */
...
require.define("/controllers/index.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
...
require.define("/controllers/co2r.coffee",function(require,module,exports,__dirname,__filename,process){(function() {

  controllers.co2r = function($scope) {
    return $scope.app_title = "CO2R";
  };
...
require.define("/controllers/directory.coffee",function(require,module,exports,__dirname,__filename,process){(function() {

  controllers.directory = function($rootScope) {
    return $rootScope.page_title = "Directory";
  };
...
require.define("/controllers/about.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
...
require.define("/routes.coffee",function(require,module,exports,__dirname,__filename,process){(function() {

  CO2R.config([
    '$routeProvider', function($routeProvider) {
      $routeProvider.when('/directory', {
        templateUrl: "" + app_settings.static_url + "templates/directory.html",
        controller: controllers.directory
      });
      $routeProvider.when('/about', {
        templateUrl: "" + app_settings.static_url + "templates/about.html",
