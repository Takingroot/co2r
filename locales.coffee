...
app_locales.en =
  ...
  # part of nav but not a real nav item
  ...
  about:
    ...
    topic_1:
      title: "Ecosystems"
      text: """
        <p class="lead"> One of the three main aims of Taking Root's project is to protect and restore ecosystems through reforestation. Here are some of the ways this is done.</p>
    ...
    topic_2:
      title: "Livlihoods"
      text: """
        <p class="lead"> A second core aim of the project is to improve the livelihoods of the participating community members through reforestation.</p>
    ...
    topic_3:
      ...
      text: """
        <p class="lead">The third core aim of the project is to use social reforestation to tackle climate change, a serious global issue that must be addressed.</p>
    ...
    community_text: """
      <p> The Limay Community Carbon Project is a community-based reforestation initiative that works with small-scale farming families in Nicaragua to restore ecosystems, improve livelihoods and tackle climate change.</p>
  ...
  colofon: """
    Colofon: Site design and frontend development by
